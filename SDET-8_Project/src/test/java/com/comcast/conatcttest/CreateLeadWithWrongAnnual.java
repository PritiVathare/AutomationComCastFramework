...
public class CreateLeadWithWrongAnnual {
	
		@Test
		public  void CreateLeadWithWrongAnnual() throws Throwable {
			...
			//Test Data
			String LastName=elib.getExcelData("Lead", "tc_03","LastName")+JavaUtils.getRanDomData();
			String LeadCompany=elib.getExcelData("Lead", "tc_03","LeadCompany");
			String AssignTo=elib.getExcelData("Lead", "tc_03","AssignTo");
			String AnnualRevenue=elib.getExcelData("Lead", "tc_03","AnnualRevenue");
