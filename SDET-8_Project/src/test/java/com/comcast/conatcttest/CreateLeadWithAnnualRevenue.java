...
public class CreateLeadWithAnnualRevenue {
	@Test
	public  void CreateLeadWithAnnualRevenue() throws Throwable {
		...
		//Test Data
		String LastName=elib.getExcelData("Lead","tc_02","LastName")+JavaUtils.getRanDomData();
		String LeadCompany=elib.getExcelData("Lead","tc_02","LeadCompany");
		String AssignTo=elib.getExcelData("Lead","tc_02","AssignTo");
		String AnnualRevenue=elib.getExcelData("Lead","tc_02","AnnualRevenue");
